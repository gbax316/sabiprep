      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="text-center py-8">
          {isTimedMode ? (
            <>
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-2">Timed Exam Complete!</h1>
        ...
        {isTimedMode ? (
          ...
          <Card variant="gradient" className="bg-gradient-to-br from-orange-600 to-pink-600 text-white">
            <div className="text-center py-8">
              <p className="text-white/90 mb-2 text-lg">Speed & Accuracy Score</p>
              <p className="text-8xl font-bold mb-4">{finalAccuracy}%</p>
          ...
          <Card variant="gradient" className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
            <div className="text-center py-8">
              <p className="text-white/90 mb-2 text-lg">Your Score</p>
              <p className="text-8xl font-bold mb-4">{finalAccuracy}%</p>
              <p className="text-white/80 text-lg mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card variant="gradient" className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white">
              <div className="text-center py-6">
                <p className="text-white/90 mb-2">First Attempt Score</p>
                <p className="text-7xl font-bold mb-2">{firstAttemptAccuracy}%</p>
            ...
            <Card variant="gradient" className="bg-gradient-to-br from-green-600 to-emerald-600 text-white">
              <div className="text-center py-6">
                <p className="text-white/90 mb-2">Final Score</p>
                <p className="text-7xl font-bold mb-2">{finalAccuracy}%</p>
                <p className="text-white/80">
                  {correctCount} out of {isTimedMode ? totalAnswered : session.total_questions} correct
                  {isTimedMode && totalAnswered < session.total_questions && (
                    <span className="text-xs text-gray-500"> ({session.total_questions - totalAnswered} unanswered)</span>
                  )}
                </p>
              </div>
              <div className="mt-4">
        ...
        {/* Stats Grid */}
        <div className={`grid grid-cols-2 ${isTestMode ? 'md:grid-cols-3' : isTimedMode ? 'md:grid-cols-4' : 'md:grid-cols-4'} gap-4`}>
          ...
          {!isTestMode && !isTimedMode && (
            <Card className="text-center">
              ...
              <p className="text-2xl font-bold text-gray-900">{finalAccuracy}%</p>
          ...
          return (
            <>
              ...
              {topicTimeStats.size > 0 && (
                <Card>
                  <h3 className="font-bold text-lg text-gray-900 mb-4">📊 Topic Speed Analysis</h3>
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-gray-200">
                          ...
                          <th className="text-center py-2 px-3 text-sm font-semibold text-gray-700">Correct</th>
                          <th className="text-center py-2 px-3 text-sm font-semibold text-gray-700">Time</th>
                          <th className="text-center py-2 px-3 text-sm font-semibold text-gray-700">Speed Rating</th>
                        </tr>
                      </thead>
                      <tbody>
                          ...
                          return (
                            <tr key={stats.topic.id} className="border-b border-gray-100">
                              <td className="py-2 px-3">
                                <span className="font-medium text-gray-900">{stats.topic.name}</span>
                              </td>
                              <td className="text-center py-2 px-3">
                                <span className="text-gray-900">{stats.total}</span>
                              </td>
                              <td className="text-center py-2 px-3">
                                <span className="text-gray-900">{stats.correct}</span>
                              </td>
                              <td className="text-center py-2 px-3">
                                <span className="text-gray-900">{formatTime(stats.avgTime)}</span>
                              </td>
                              <td className="text-center py-2 px-3">
                                <span className={`font-semibold ${speedColor}`}>
        ...
        {(session.mode === 'test' || session.mode === 'timed') && topics.length > 0 && topicAnalytics.size > 0 && (() => {
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-center py-3 px-4 text-sm font-semibold text-gray-700">Correct</th>
                    {isTimedMode && timedTopicTimeStats && (
                  ...
                  {topics
                    ...
                    .map((item) => (
                      <tr key={item!.topic.id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="text-center py-3 px-4 text-gray-700">{item!.analytics.total}</td>
                        <td className="text-center py-3 px-4 text-gray-700">{item!.analytics.correct}</td>
                        {isTimedMode && timedTopicTimeStats && (() => {
                        ...
                        <td className="text-center py-3 px-4">
                          <span className={`font-semibold ${item!.ratingColor}`}>
                            {item!.rating}
                            {item!.score < 75 && ' ⚠️'}
                          </span>
                        </td>
                ...
                {getAlternativeModes().map(mode => {
                  ...
                  return (
                    <Button
                      ...
                      disabled={creatingSession}
                      className={`
                        border-2 font-semibold text-gray-900
                        ${hoverStyles}
                        transition-all
