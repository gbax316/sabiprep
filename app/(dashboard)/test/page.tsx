...
import { ArrowLeft, BookOpen, TrendingUp, Play, ChevronRight, AlertCircle } from 'lucide-react';
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {selectedSubject ? selectedSubject.name : 'Test Mode'}
              </h1>
              <p className="text-sm text-gray-600">
                {selectedSubject 
                  ? 'Select a topic to start your test'
                  : 'Simulate exam conditions with no hints or explanations until the end'}
              </p>
            </div>
          </div>
          ...
          {!selectedSubject && (
            <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-2">
              ...
              <div className="text-sm text-amber-800">
                <p className="font-medium">Test Mode Features:</p>
                <ul className="mt-1 space-y-0.5 list-disc list-inside">
                  <li>No hints or explanations during the test</li>
