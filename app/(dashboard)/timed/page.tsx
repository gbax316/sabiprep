...
import { ArrowLeft, BookOpen, TrendingUp, Play, ChevronRight, Timer, AlertCircle } from 'lucide-react';
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-2xl font-bold text-gray-900">
                  {selectedSubject ? selectedSubject.name : 'Timed Mode'}
                </h1>
              ...
              <p className="text-sm text-gray-600">
                {selectedSubject 
                  ...
                  : 'Challenge yourself with time limits to improve speed and accuracy'}
              </p>
            </div>
          </div>
          ...
          {!selectedSubject && (
            <div className="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-lg flex items-start gap-2">
              ...
              <div className="text-sm text-orange-800">
                <p className="font-medium">Timed Mode Features:</p>
                <ul className="mt-1 space-y-0.5 list-disc list-inside">
                  <li>Each question has a time limit</li>
                  <li>Build speed and accuracy under pressure</li>
                  ...
                  <Card className="hover:shadow-lg transition-all">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-shrink-0">
                        <div className="w-12 h-12 bg-orange-600 hover:bg-orange-700 rounded-full flex items-center justify-center transition-colors">
